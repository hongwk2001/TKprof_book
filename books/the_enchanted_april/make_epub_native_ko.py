"""
make_epub_ko.py
Compiles the Korean version of The Enchanted April into an EPUB file.
"""
...
OUTPUT_FILE   = os.path.join(BASE_DIR, "the_enchanted_april_ko.epub")
...
<body>
  <img src="../Images/cover_ko.png" alt="Cover" />
    ...
    opf_parts = [
        ...
        "    <dc:title>마법에 걸린 4월 ( Enchanted April )</dc:title>",
        "    <dc:language>ko</dc:language>",
        "    <dc:creator>엘리자베스 폰 아르님 (Elizabeth von Arnim)</dc:creator>",
        "    <dc:publisher>TKPROF LLC</dc:publisher>",
        "    <dc:date>2026-07-07</dc:date>",
        "    <dc:description>서로 전혀 다른 네 명의 영국 여성이 우울한 런던을 벗어나 한 달 동안 지중해 연안의 중세 이탈리아 성을 렌트하며, 이탈리아의 아름다운 풍경과 꽃, 햇살 속에서 상처를 치유하고 서로를 보듬어가는 사랑과 우정의 힐링 로맨스 소설.</dc:description>",
    ...
    ncx_parts = [
        ...
        "  <head>",
        "    <meta name=\"dtb:uid\" content=\"tkprof-enchanted-april-ko-2026\"/>",
...
<container version="1.0" xmlns="urn:oasis:names:tc:opendocument:xmlns:container">
  <rootfiles>
    ...
    with zipfile.ZipFile(OUTPUT_FILE, "w", zipfile.ZIP_DEFLATED) as epub:
        ...
        epub.write(os.path.join(BASE_DIR, "cover_ko.png"), "OEBPS/Images/cover_ko.png")
    ...
    print(f"Korean EPUB created successfully at: {OUTPUT_FILE}")
