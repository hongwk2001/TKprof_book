...
def main():
    ...
    overview_txt = os.path.join(BASE_DIR, "overview_ko.txt")
    ...
    for i in range(1, 23):
        ch_txt = os.path.join(CHAPTERS_DIR, f"ch_{i:02d}_ko.txt")
    ...
    closing_txt = os.path.join(BASE_DIR, "copyright_ko.txt")
