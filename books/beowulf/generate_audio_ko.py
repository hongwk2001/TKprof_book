...
async def generate_chapter(ch_arg):
    ...
    # Let's synthesize all segments sequentially to keep edge-tts API happy, or in small batches.
...
def create_filelists():
    ...
    part1 = ["final_track_00_intro.mp3"] + [f"final_track_{i:02d}.mp3" for i in range(16)]
    part2 = [f"final_track_{i:02d}.mp3" for i in range(16, 31)]
    part3 = [f"final_track_{i:02d}.mp3" for i in range(31, 43)]
    part4 = ["final_track_43.mp3", "closing.mp3"]
