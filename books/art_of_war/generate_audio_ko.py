...
def main():
    print("=== Generating Korean Audio for Sun Tzu: The Art of War ===")

    # 1. Opening Track
    opening_text = "손자병법. 손무 지음. 인준 낭독."
    ...
    # 5. Retail Sample
    sample_text = "손자병법. 손자 지음. 제1장: 시계. 손자가 말하기를, 전쟁의 기술은 국가의 중대한 일이다. 그것은 사활이 걸린 문제이며 안전이나 파멸로 가는 길이다."
