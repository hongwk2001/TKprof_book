...
def main():
    print("=== Generating Audio for Sun Tzu: The Art of War ===")

    # 1. Opening Track (Strict Authors Republic Rule: Title, Author, Narrator only)
    opening_text = "The Art of War. Written by Sun Tzu. Narrated by Andrew."
    ...
    # 5. Retail Sample
    sample_text = "The Art of War by Sun Tzu. Chapter One: Laying Plans. Sun Tzu said: The art of war is of vital importance to the State. It is a matter of life and death, a road either to safety or to ruin. Hence it is a subject of inquiry which can on no account be neglected. The art of war is governed by five constant factors: The Moral Law, Heaven, Earth, The Commander, and Method and Discipline."
