...
# Voice mapping based on approved plan for Korean
VOICE_MAP = {
    "Narrator": ("ko-KR-InJoonNeural", 1.0),
    "odysseus": ("ko-KR-HyunsuMultilingualNeural", 1.0),
    "telemachus": ("ko-KR-InJoonNeural", 1.0),
...
def parse_tagged_text(content):
    ...
    # Find tags matching XML structure
...
def main():
    ...
    for filename in sorted(os.listdir(TAGGED_DIR)):
        if filename.endswith("_ko.txt"):
            ...
            out_filename = f"script_ch_{ch_num}_ko.json"
