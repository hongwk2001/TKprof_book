...
BG_PATH = r"C:\Users\hongw\.gemini\antigravity\brain\4dfea7aa-a295-4ab3-a4c0-bb558485c98b\odyssey_cover_bg_1786744226983.jpg"
...
def main():
    ...
    font_title = ImageFont.truetype('C:/Windows/Fonts/batang.ttc', 150)
    ...
    # Title & Subtitle
    add_text_with_glow('오디세이아', 255, font_title, (255, 253, 245, 255), glow_color=(15, 10, 5, 240))
    add_text_with_glow('The Odyssey (Odysseia)', 445, font_sub, (240, 215, 155, 255), glow_color=(15, 10, 5, 240))

    # Gold accent ornament line
    draw_txt.line([(680, 535), (920, 535)], fill=(240, 215, 155, 180), width=2)
    draw_shd.line([(680, 535), (920, 535)], fill=(0, 0, 0, 180), width=4)

    # Bottom elements
    add_text_with_glow('호메로스 지음 | TKPROF LLC 편역', 1980, font_author_ko, (255, 255, 255, 255))
    add_text_with_glow('Homer | Translated & Edited by TKPROF LLC', 2065, font_author_en, (235, 215, 170, 255))
    ...
    print("✅ Generated Odyssey Korean cover images successfully.")
