...
OUT_FILE = os.path.join(SCRIPT_DIR, "audio_ar_mastered", "99_ar_closing.mp3")

async def generate():
    voice = "ko-KR-SunHiNeural"
    text = "이상으로 블루 캐슬 오디오북을 마칩니다."
    communicate = edge_tts.Communicate(text, voice, rate="+0%")
    temp_mp3 = os.path.join(SCRIPT_DIR, "temp_closing.mp3")
...
def master(src, dst):
    ...
    err_file = os.path.join(SCRIPT_DIR, 'err_c.txt')
    ...
    list_txt = os.path.join(SCRIPT_DIR, 'list_closing.txt')
...
if __name__ == '__main__':
    ...
    print("Created 99_ar_closing.mp3 successfully!")
