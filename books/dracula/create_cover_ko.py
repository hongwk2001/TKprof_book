...
for '드라큘라 - 한영 대역판 (Dracula: Bilingual Edition)'.
"""
...
BG_PATH = r"C:\Users\hongw\.gemini\antigravity\brain\4dfea7aa-a295-4ab3-a4c0-bb558485c98b\dracula_cover_bg_1786746923266.jpg"
...
def main():
    ...
    font_title = ImageFont.truetype('C:/Windows/Fonts/batang.ttc', 160)
    font_sub = ImageFont.truetype('C:/Windows/Fonts/batang.ttc', 60)
    ...
    # Title & Subtitle
    add_text_with_glow('드라큘라', 255, font_title, (255, 253, 245, 255), glow_color=(15, 10, 5, 240))
    add_text_with_glow('영한 대역판 (Dracula: English-Korean Edition)', 455, font_sub, (240, 215, 155, 255), glow_color=(15, 10, 5, 240))

    # Gold accent ornament line
    draw_txt.line([(680, 545), (920, 545)], fill=(240, 215, 155, 180), width=2)
    draw_shd.line([(680, 545), (920, 545)], fill=(0, 0, 0, 180), width=4)

    # Bottom elements
    add_text_with_glow('브램 스토커 지음 | TKPROF LLC 편역', 1980, font_author_ko, (255, 255, 255, 255))
    add_text_with_glow('Bram Stoker | Parallel Edition by TKPROF LLC', 2065, font_author_en, (235, 215, 170, 255))
    ...
    final_rgb.save(os.path.join(BASE_DIR, 'cover.jpg'), quality=95, dpi=(300, 300))
    ...
    print("✅ Generated Dracula Korean Bilingual cover images successfully.")
