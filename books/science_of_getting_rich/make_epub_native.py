"""
make_epub_native.py
Compiles the modernized edition of The Science of Getting Rich into an EPUB file directly using python's zipfile.
...
OUTPUT_FILE   = os.path.join(BASE_DIR, "the_science_of_getting_rich.epub")
...
def txt_to_html(text, title):
    ...
    for line in lines:
        ...
        if not body_started:
            if line.lower().startswith("chapter ") or line.lower().startswith("preface") or line.lower() == title.lower():
                continue
            body_started = True
...
def main():
    ...
    # 2. Chapters (including ch_00 Preface)
...
<body>
  <img src="../Images/cover.png" alt="Cover" />
    ...
    opf_parts = [
        ...
        "    <dc:title>The Science of Getting Rich</dc:title>",
        "    <dc:language>en</dc:language>",
        "    <dc:creator>Wallace D. Wattles</dc:creator>",
        "    <dc:publisher>TKPROF LLC</dc:publisher>",
        "    <dc:date>2026-07-05</dc:date>",
        "    <dc:description>Wallace D. Wattles' timeless classic on the mental and spiritual principles of wealth creation. Originally published in 1910.</dc:description>",
        ...
        "    <dc:subject>New Thought</dc:subject>",
    ...
    ncx_parts = [
        ...
        "  </head>",
        "  <docTitle><text>The Science of Getting Rich</text></docTitle>",
        "  <navMap>"
    ]
    play_order = 1
    for ch in chapters:
...
<container version="1.0" xmlns="urn:oasis:names:tc:opendocument:xmlns:container">
  <rootfiles>
    <rootfile full-path="OEBPS/content.opf" media-type="application/oebps-package+xml"/>
        ...
        # 4. Cover Image
        cover_img_path = os.path.join(BASE_DIR, "cover.png")
        if os.path.exists(cover_img_path):
            epub.write(cover_img_path, "OEBPS/Images/cover.png")
            print("Cover image packaged.")
        else:
            print("Warning: cover.png not found. EPUB created without a cover image.")
