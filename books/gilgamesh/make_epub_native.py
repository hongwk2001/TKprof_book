...
OUTPUT_FILE   = os.path.join(BASE_DIR, "gilgamesh_en.epub")
...
def main():
    ...
    opf_parts = [
        ...
        "    <dc:identifier id=\"pub-id\">tkprof-gilgamesh-2026</dc:identifier>",
    ...
    ncx_parts = [
        ...
        "  <head>",
        "    <meta name=\"dtb:uid\" content=\"tkprof-gilgamesh-2026\"/>",
        "    <meta name=\"dtb:depth\" content=\"1\"/>",
        "    <meta name=\"dtb:totalPageCount\" content=\"0\"/>",
        "    <meta name=\"dtb:maxPageNumber\" content=\"0\"/>",
        "  </head>",
        "  <docTitle><text>The Epic of Gilgamesh</text></docTitle>",
        "  <navMap>"
    ]
