...
def main():
    print("=== Generating Korean Audio for Seneca: On the Shortness of Life ===")

    # 1. Opening Track
    opening_text = "인생의 짧음에 관하여. 루키우스 안나에우스 세네카 지음. 인준 낭독."
    ...
    # 4. Closing Track
    closing_text = "인생의 짧음에 관하여 오디오북 낭독을 마칩니다. 세네카 지음, 인준 낭독. 저작권 2026년 Antigravity Classics. 판권 소유."
    raw_closing = os.path.join(TEMP_DIR, "raw_closing_ko.mp3")
    final_closing = os.path.join(FINAL_DIR, "final_track_22_closing_ko.mp3")
    print("Generating Closing Track...")
    generate_tts(closing_text, raw_closing)
    process_track(raw_closing, final_closing)

    # 5. Retail Sample
    sample_text = "인생의 짧음에 관하여. 루키우스 안나에우스 세네카 지음. 1장: 인생이 짧다는 불평. 바울리누스여, 대부분의 인간은 자연의 인색함에 대해 불평합니다. 그것은 우리가 짧은 수명을 갖고 태어났기 때문입니다."
