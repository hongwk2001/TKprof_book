"""
make_epub_native.py
Compiles Seneca's On the Shortness of Life into an English EPUB3 eBook directly using Python's zipfile.
"""
...
OUTPUT_FILE = os.path.join(BASE_DIR, "seneca_shortness_of_life_en.epub")
...
def txt_to_html(text, title):
    ...
    for line in lines:
        ...
        if not line_s:
            continue
        if line_s.startswith("Chapter ") or line_s.startswith("# "):
            continue
...
def build_epub():
    ...
    chapters_data = []
    chapter_titles = [
        "Chapter I: The Complaint of Short Life",
        "Chapter II: How Men Waste Time",
        "Chapter III: Guarding Your Life's Hours",
        "Chapter IV: Augustus and the Longing for Leisure",
        "Chapter V: Cicero's Struggle with Public Life",
        "Chapter VI: Livius Drusus and Restless Ambition",
        "Chapter VII: The Distracted Mind",
        "Chapter VIII: The Illusion of Endless Time",
        "Chapter IX: Living in the Present",
        "Chapter X: The Three Times of Life",
        "Chapter XI: The Fear of Death",
        "Chapter XII: The Trifles of Trivial Pursuits",
        "Chapter XIII: Pedantry vs. Wisdom",
        "Chapter XIV: Friendship with Great Minds",
        "Chapter XV: True Immortality",
        "Chapter XVI: The Anxiety of the Busy",
        "Chapter XVII: The Sudden End of Power",
        "Chapter XVIII: Paulinus' Advice to Retire",
        "Chapter XIX: The Dignity of Philosophy",
        "Chapter XX: The Tranquil Conclusion"
    ]
...
<package xmlns="http://www.idpf.org/2007/opf" unique-identifier="BookId" version="3.0">
  <metadata xmlns:dc="http://purl.org/dc/elements/1.1/">
    ...
    <dc:title>On the Shortness of Life</dc:title>
    <dc:creator>Seneca</dc:creator>
    <dc:language>en</dc:language>
    <dc:publisher>Antigravity Classics</dc:publisher>
...
<ncx xmlns="http://www.daisy.org/z3986/2005/ncx/" version="2005-1">
  ...
  <docTitle><text>On the Shortness of Life</text></docTitle>
  <navMap>
{nav_points_str}
  </navMap>
</ncx>"""
