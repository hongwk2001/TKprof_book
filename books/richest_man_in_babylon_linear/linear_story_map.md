...
```mermaid
graph TD
    subgraph Act 1: The Bottom
        A[Tarkad: Starving & Debt-Ridden] --> B[Seeks loan from Mathon the Gold Lender]
        B -->|Rejected: No collateral/plan| C[Tarkad meets a rising Arkad in Mathon's shop]
    end

    subgraph Act 2: The Mentorship
        C -->|Arkad offers a job, not a handout| D[Arkad teaches the Seven Cures during work]
        D -->|Tarkad works with Old Banzar| E[Rebuilding the Walls of Babylon]
    end

    subgraph Act 3: The Trials
        E -->|Tarkad is tempted by quick wealth| F[Arkad warns him with the Five Laws of Gold]
        F -->|Tarkad goes on a caravan journey| G[Meets Dabasir: The Camel Trader's escape story]
    end

    subgraph Act 4: Redemption
        G -->|Tarkad returns determined| H[Mathon structures Tarkad's 70-20-10 debt plan]
        H -->|Tarkad repays all creditors| I[Tarkad becomes Arkad's partner & mentor to others]
end
```
