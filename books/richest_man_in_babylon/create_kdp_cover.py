...
output_path = r"d:\git_repo\TKprof_book\books\richest_man_in_babylon\cover_kdp.jpg"
...
if aspect_ratio_orig > aspect_ratio_target:
    # Source is wider than target aspect ratio (e.g. landscape/square -> portrait)
    # Scale based on height, then crop the sides
    ...
    # Source is taller or equal (unlikely for typical square/landscape generations)
    # Scale based on width, then crop top/bottom
...
# KDP cover dimensions are large (1600x2560), so we use large font sizes
try:
    ...
    font_subtitle = ImageFont.truetype(font_path_regular, 50)
...
# Draw Title
# Golden/amber gradient look for title
...
# Draw Subtitle/Edition info
subtitle_color = "#FFFFFF" # Crisp white
draw_text_centered_with_shadow("Modern English Edition", 650, font_subtitle, subtitle_color)
...
print(f"Successfully generated KDP cover at {output_path}")
