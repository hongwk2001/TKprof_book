...
def split_file(filepath, num_parts=4):
...
split_file('d:/git_repo/TKprof_book/books/richest_man_in_babylon/chapters/raw_ch_06_seven_cures_for_a_lean_purse.txt', 4)
