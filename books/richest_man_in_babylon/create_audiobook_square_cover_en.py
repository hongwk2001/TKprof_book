...
BG_PATH = r"C:\Users\hongw\.gemini\antigravity\brain\b001e168-a118-4939-a5bf-ec09aec35aee\babylon_cover_bg_1786931050251.jpg"
...
def create_square_english_cover():
    ...
    font_title = ImageFont.truetype('C:/Windows/Fonts/georgiab.ttf', 125)
    font_sub = ImageFont.truetype('C:/Windows/Fonts/georgiai.ttf', 70)
    font_author = ImageFont.truetype('C:/Windows/Fonts/georgiab.ttf', 60)
    ...
    add_text_with_glow('THE RICHEST MAN', 300, font_title, (255, 253, 245, 255))
    add_text_with_glow('IN BABYLON', 450, font_title, (255, 253, 245, 255))
    add_text_with_glow('Modern English Edition', 610, font_sub, (240, 215, 155, 255))

    add_text_with_glow('GEORGE S. CLASON', 1980, font_author, (235, 215, 170, 255))
    ...
    print(f"✅ Generated 2400x2400 px Square English Cover: {DST_COVER_2400} ({size_mb:.2f} MB)")
