...
Compiles Seneca's Of a Happy Life into a Korean EPUB3 eBook directly using Python's zipfile.
"""
...
OUTPUT_FILE = os.path.join(BASE_DIR, "seneca_on_happiness_ko.epub")
...
def build_epub():
    ...
    for i in range(1, 29):
        ...
        # Parse title from the first line (e.g. "[1장: 행복한 삶의 정의와 군중의 오류]")
...
<body style="margin:0; padding:0; text-align:center;">
  <img src="../Images/cover.jpg" alt="Cover" class="cover-img"/>
        ...
        if intro_text:
            z.writestr("OEBPS/Text/intro.xhtml", txt_to_html(intro_text, "소개"))
            ...
            ncx_targets.append(("소개", "Text/intro.xhtml"))
            nav_targets.append(("소개", "Text/intro.xhtml"))

        if overview_text:
            z.writestr("OEBPS/Text/overview.xhtml", txt_to_html(overview_text, "개요"))
            ...
            ncx_targets.append(("개요", "Text/overview.xhtml"))
            nav_targets.append(("개요", "Text/overview.xhtml"))
        ...
        if copyright_text:
            z.writestr("OEBPS/Text/copyright.xhtml", txt_to_html(copyright_text, "판권 및 크레딧"))
            ...
            ncx_targets.append(("판권 및 크레딧", "Text/copyright.xhtml"))
            nav_targets.append(("판권 및 크레딧", "Text/copyright.xhtml"))
...
<package xmlns="http://www.idpf.org/2007/opf" unique-identifier="BookId" version="3.0">
  <metadata xmlns:dc="http://purl.org/dc/elements/1.1/">
    ...
    <dc:title>행복한 삶에 관하여</dc:title>
    <dc:creator>세네카</dc:creator>
...
<ncx xmlns="http://www.daisy.org/z3986/2005/ncx/" version="2005-1">
  ...
  <docTitle><text>행복한 삶에 관하여</text></docTitle>
  <navMap>
{nav_points_str}
  </navMap>
</ncx>"""
...
{nav_li_str}
    ...
    print(f"Successfully compiled native EPUB (KO): {OUTPUT_FILE} ({os.path.getsize(OUTPUT_FILE)} bytes)")
