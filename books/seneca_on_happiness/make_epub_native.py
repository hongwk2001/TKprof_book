"""
make_epub_native.py
Compiles Seneca's Of a Happy Life into an English EPUB3 eBook directly using Python's zipfile.
"""
...
OUTPUT_FILE = os.path.join(BASE_DIR, "seneca_on_happiness_en.epub")
...
def build_epub():
    ...
    for i in range(1, 29):
        ...
        # Parse title from the first line (e.g. "[Chapter 1: The Universal Quest for Happiness]")
...
<package xmlns="http://www.idpf.org/2007/opf" unique-identifier="BookId" version="3.0">
  <metadata xmlns:dc="http://purl.org/dc/elements/1.1/">
    ...
    <dc:title>Of a Happy Life</dc:title>
...
<ncx xmlns="http://www.daisy.org/z3986/2005/ncx/" version="2005-1">
  ...
  <docTitle><text>Of a Happy Life</text></docTitle>
  <navMap>
{nav_points_str}
  </navMap>
</ncx>"""
