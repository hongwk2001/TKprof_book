...
def main():
    print("=== Generating Audio for Seneca: Of a Happy Life ===")

    # 1. Opening Track
    opening_text = "Of a Happy Life. Written by Lucius Annaeus Seneca. Narrated by Andrew."
    ...
    # 4. Closing Track
    closing_text = "This concludes the audiobook of Of a Happy Life, written by Lucius Annaeus Seneca, narrated by Andrew. Copyright 2026 by Antigravity Classics. All rights reserved."
    raw_closing = os.path.join(TEMP_DIR, "raw_closing.mp3")
    final_closing = os.path.join(FINAL_DIR, f"final_track_30_closing.mp3")
    print("Generating Closing Track...")
    generate_tts(closing_text, raw_closing)
    process_track(raw_closing, final_closing)

    # 5. Retail Sample
    sample_text = "Of a Happy Life by Lucius Annaeus Seneca. Chapter One. Brother Gallio, everyone wants to live a happy life, but few understand what truly makes life happy. In fact, happiness is so difficult to achieve that the more eagerly someone pursues it, the further they stray."
