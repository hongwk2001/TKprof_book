...
Compiles H. G. Wells' Tono-Bungay (Korean Literary Edition) into an EPUB3 eBook.
"""
...
STYLE = """
body {
    font-family: 'KoPubWorldBatang', 'NanumMyeongjo', 'Batang', serif;
    font-size: 1.05em;
    line-height: 1.7;
    margin: 1.5em 2em;
    color: #111111;
  ...
  <div>
    ...
    for b_num, ch_list in chapters_structure:
        ...
        for c_num in ch_list:
            filepath = os.path.join(CHAPTERS_DIR, f"book{b_num}", f"book{b_num}_ch{c_num:02d}_ko.txt")
...
<package xmlns="http://www.idpf.org/2007/opf" version="3.0" unique-identifier="pub-id">
  <metadata xmlns:dc="http://purl.org/dc/elements/1.1/">
    ...
    <dc:title>토노 벙게 (H.G. 웰스 현대 한국어판)</dc:title>
    <dc:language>ko</dc:language>
    <dc:creator>H. G. 웰스</dc:creator>
    <dc:publisher>TKprof 출판사</dc:publisher>
...
<ncx xmlns="http://www.daisy.org/z3986/2005/ncx/" version="2005-1">
  ...
  <docTitle><text>토노 벙게 (H.G. 웰스 현대 한국어판)</text></docTitle>
  <navMap>
{toc_ncx_str}
  </navMap>
</ncx>'''
