...
for 'Scaramouche: Book 1 - The Robe'.
"""
...
BG_PATH = r"C:\Users\hongw\.gemini\antigravity\brain\4dfea7aa-a295-4ab3-a4c0-bb558485c98b\scaramouche_cover_bg_1786751182392.jpg"
...
def main():
    ...
    font_title = ImageFont.truetype('C:/Windows/Fonts/georgiab.ttf', 130)
    font_sub = ImageFont.truetype('C:/Windows/Fonts/georgiai.ttf', 65)
    font_author = ImageFont.truetype('C:/Windows/Fonts/georgia.ttf', 55)
    ...
    # Title & Subtitle
    add_text_with_glow('Scaramouche', 265, font_title, (255, 253, 245, 255), glow_color=(15, 10, 5, 240))
    add_text_with_glow('Book 1: The Robe', 435, font_sub, (240, 215, 155, 255), glow_color=(15, 10, 5, 240))
    ...
    # Bottom elements
    add_text_with_glow('Rafael Sabatini', 2040, font_author, (235, 215, 170, 255))
    ...
    print("✅ Generated Scaramouche Book 1 cover images successfully.")
