...
for f in glob.glob('d:/git_repo/TKprof_book/books/scaramouche/chapters/book_2/ch_*_en.txt'):
...
for f in glob.glob('d:/git_repo/TKprof_book/books/scaramouche/chapters/book_2/ch_*_ko.txt'):
    with open(f, 'r', encoding='utf-8') as file:
        text = file.read()
...
print('Optimization for Book 2 done.')
