...
if isinstance(wq_data, dict) and 'batches' in wq_data:
    batches = wq_data['batches']
else:
    batches = wq_data

batches_to_process = [b for b in batches if b['chapter'] == chapter_name and b['status'] == 'pending']
...
print(f"Chapter complete. {len(batches_to_process)} batches translated.")
